...
class PlayerViewController: UIViewController, AVPictureInPictureControllerDelegate {
    ...
    @IBOutlet var pictureInPictureButton: UIBarButtonItem!
    ...
    @IBAction func togglePictureInPictureMode(_: UIButton) {
        /*
    ...
    private func setupPlayback() {
         ...
         */
        playerItem = AVPlayerItem(asset: asset, automaticallyLoadedAssetKeys: PlayerViewController.assetKeysRequiredToPlay)
    }
    ...
    private func setupPictureInPicturePlayback() {
        ...
        if AVPictureInPictureController.isPictureInPictureSupported() {
            ...
            pictureInPicturePossibleObserver = observe(\PlayerViewController.pictureInPictureController.isPictureInPicturePossible,
    ...
    func pictureInPictureControllerFailedToStartPictureInPicture(pictureInPictureController _: AVPictureInPictureController, withError error: NSError) {
        /*
